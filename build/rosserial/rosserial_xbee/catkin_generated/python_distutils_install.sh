...
echo_and_run cd "/home/yoav/catkin_ws/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/yoav/catkin_ws/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/yoav/catkin_ws/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
